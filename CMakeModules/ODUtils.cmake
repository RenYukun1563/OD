...
function(od_get_dll _lib _dll)
    ...
    set( DLLPATH_CANDIDATES )
    foreach( _i RANGE 0 5 )
	if ( IS_DIRECTORY "${DLLBASEPATH}/bin" )
	    list( APPEND DLLPATH_CANDIDATES "${DLLBASEPATH}/bin" )
	endif()
	if ( IS_DIRECTORY "${DLLBASEPATH}/../bin/Debug" )
	    get_filename_component( DLLDEBUGPATH "${DLLBASEPATH}/../bin/Debug" REALPATH )
	    list( APPEND DLLPATH_CANDIDATES "${DLLDEBUGPATH}" )
	    unset( DLLDEBUGPATH )
	endif()
	get_filename_component( DLLBASEPATH "${DLLBASEPATH}" DIRECTORY )
    endforeach()
    list( REMOVE_DUPLICATES DLLPATH_CANDIDATES )
    get_filename_component( BASEFILENM "${_lib}" NAME_WE )
    foreach( DLLPATH ${DLLPATH_CANDIDATES} )
