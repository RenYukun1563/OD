...
macro( OD_COPY_IMPORTED_HDF5_TARGET SOURCE_TARGET TARGET_NAME )
    if ( TARGET ${SOURCE_TARGET} AND NOT TARGET ${TARGET_NAME} )
	...
	foreach( TARGET_PROP
	    ...
	    get_target_property( TARGET_PROP_VALUE ${SOURCE_TARGET} ${TARGET_PROP} )
	    if ( TARGET_PROP_VALUE )
		set_target_properties( ${TARGET_NAME} PROPERTIES
		    ${TARGET_PROP} "${TARGET_PROP_VALUE}" )
	    endif()
	endforeach()
    endif()
endmacro(OD_COPY_IMPORTED_HDF5_TARGET)

macro( OD_NORMALIZE_HDF5_TARGETS )
    OD_COPY_IMPORTED_HDF5_TARGET( hdf5-shared hdf5::hdf5-shared )
    OD_COPY_IMPORTED_HDF5_TARGET( hdf5_cpp-shared hdf5::hdf5_cpp-shared )
endmacro(OD_NORMALIZE_HDF5_TARGETS)
